...
**Reference Rule:** `.claude/context/nextjs_frontend/nextjs-docker-standards.md`
...
**For complete Docker setup guidance, see `.claude/context/nextjs_frontend/nextjs-docker-standards.md`.**
